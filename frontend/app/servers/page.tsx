        ...
        {servers.map((s, idx) => {
          return (
            <motion.div
              ...
              className="bg-[#151515] rounded-card p-6 cursor-pointer relative flex flex-col justify-between h-64 group border border-border hover:border-primary/45 hover:bg-[#1A1A1A] transition-all duration-300 shadow-md animate-fade-in"
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-[14px] text-text group-hover:text-primary transition-colors">
                      {s.hostname}
                    </span>
                  </div>
                ...
                <div className="text-caption text-[#A1A1AA] mt-3 space-y-1 font-normal">
                  ...
                  <div className="flex justify-between items-center pt-0.5">
                    ...
                    <span className="font-medium text-[11px] text-text">{s.lastSeen}</span>
                  </div>
                </div>
              </div>

              {/* Hardware Dials Overview */}
              <div className="grid grid-cols-3 gap-3 border-t border-border/60 py-3.5 my-3 text-caption font-bold">
                <div className="text-center">
                  <span className="text-[#71717A] block font-normal text-[11px]">CPU</span>
                  <span className="text-text mt-0.5 block">{s.cpuUsage}%</span>
                </div>
                <div className="text-center border-x border-border/60">
                  <span className="text-[#71717A] block font-normal text-[11px]">RAM</span>
                  <span className="text-text mt-0.5 block">{s.ramUsage}%</span>
                </div>
                <div className="text-center">
                  <span className="text-[#71717A] block font-normal text-[11px]">DISK</span>
              ...
              <div className="flex items-center justify-between border-t border-border/60 pt-4 mt-auto">
                <div className="flex items-center gap-2 text-caption">
                  <span className="text-[#71717A] font-normal">Security Posture Score:</span>
                  <span className={`font-bold ${
